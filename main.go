...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	speedMs := w.meanSpeed() * 1000 / 3600
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedMs, 2.0)*1000/3600/w.Height/CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()*MinInHours))
}
